...
if dap_ok then
  vim.keymap.set("n", "<leader>du", "<cmd>DapViewToggle<CR>", { desc = "DAP: Toggle Dap View" })
  vim.keymap.set("n", "<leader>db", dap.toggle_breakpoint, { desc = "DAP: Toggle breakpoint" })
  vim.keymap.set("n", "<leader>dc", dap.continue, { desc = "DAP: Continue" })
  vim.keymap.set("n", "<leader>di", "<cmd>DapStepInto<CR>", { desc = "DAP: StepInto" })
  vim.keymap.set("n", "<leader>do", "<cmd>DapStepOut<CR>", { desc = "DAP: StepOut" })
  vim.keymap.set("n", "<leader>dl", "<cmd>DapStepOver<CR>", { desc = "DAP: StepOver" })
...
local mappings = {
  ...
  { mode = "n", lhs = "<C-d>",      rhs = "<C-d>zz",      desc = "Half down",        scope = "global" },
  { mode = "n", lhs = "<C-u>",      rhs = "<C-u>zz",      desc = "Half down",        scope = "global" },
  ...
  { mode = "n", lhs = "<leader>de", rhs = vim.diagnostic.open_float, desc = "Line diagnostics", scope = "global" },
  {
    ...
    desc = "Diagnostics → qflist",
    scope = "global",
  },

  { mode = "n", lhs = "]f",         rhs = ":cnext <CR>",      desc = "Next QfList item",     scope = "global" },
  { mode = "n", lhs = "[f",         rhs = ":cprevious <CR>",  desc = "Previous QfList item", scope = "global" },
...
function M.setup()
  for _, m in ipairs(mappings) do
    if m.scope == "global" then
      vim.keymap.set(m.mode, m.lhs, m.rhs, { desc = m.desc, silent = true, noremap = true })
    end
  end
end
